...
class QUMG_API SWebBrowserExtend
...
public:
	...
	SLATE_BEGIN_ARGS(SWebBrowserExtend)
...
//#pragma endregion
		...
		SLATE_EVENT(SWebBrowserView::FOnUnhandledKeyDown, OnUnhandledKeyDown);

		SLATE_EVENT(SWebBrowserView::FOnUnhandledKeyUp, OnUnhandledKeyUp);
...
private:
	...
	SWebBrowserView::FOnUnhandledKeyDown OnUnhandledKeyDown;
	SWebBrowserView::FOnUnhandledKeyUp OnUnhandledKeyUp;
#pragma endregion extend
