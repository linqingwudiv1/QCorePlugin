...
namespace PlatformInfo
{
	 ...
	 */
	QDESKTOPPLATFORM_API const FPlatformInfo* FindPlatformInfo(const FName& InPlatformName);
	 ...
	 * @return The platform info if the platform was found, null otherwise
	 */
	QDESKTOPPLATFORM_API const FPlatformInfo* FindVanillaPlatformInfo(const FName& InPlatformName);

	/**
	 * Get an array of all the platforms we know about
	 * @return The pointer to the start of the platform array
	 */
	QDESKTOPPLATFORM_API const TArray<FPlatformInfo>& GetPlatformInfoArray();
	 ...
	 */
	QDESKTOPPLATFORM_API TArray<FVanillaPlatformEntry> BuildPlatformHierarchy(const EPlatformFilter InFilter);
	...
	*/
	QDESKTOPPLATFORM_API FVanillaPlatformEntry BuildPlatformHierarchy(const FName& InPlatformName, const EPlatformFilter InFilter);
	 ...
	 * @return The pointer to the start of the platform array
	 */
	QDESKTOPPLATFORM_API void UpdatePlatformSDKStatus(FString InPlatformName, EPlatformSDKStatus InStatus);
	...
	*/
	QDESKTOPPLATFORM_API void UpdatePlatformDisplayName(FString InPlatformName, FText InDisplayName);
	...
	*/
	QDESKTOPPLATFORM_API const TArray<FName>& GetAllPlatformGroupNames();
	...
	* @return An array of FNames.
	*/
	QDESKTOPPLATFORM_API const TArray<FName>& GetAllVanillaPlatformNames();
}
